    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.cls_allow_reverse is not None and cls_target is not None:
            if_reverse = (cosine_similarity(
                box_target[..., [SIN_YAW, COS_YAW]], box[..., [SIN_YAW, COS_YAW]], dim=-1) < 0)
            ...
            box_target[..., [SIN_YAW, COS_YAW]] = torch.where(
                if_reverse[..., None], -box_target[..., [SIN_YAW, COS_YAW]], box_target[..., [SIN_YAW, COS_YAW]])
        ...
        if quality is not None:
            ...
            yns_target = (cosine_similarity(box_target[..., [SIN_YAW, COS_YAW]], box[..., [SIN_YAW, COS_YAW]], dim=-1) > 0)
